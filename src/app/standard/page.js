...
<section className="max-w-5xl mx-auto px-6 pb-16">
  <h2 className="text-xl md:text-2xl font-semibold mb-6 border-b-2 border-blue-900 w-fit">
    Standard Room Price Comparison
  </h2>
  ...
  >
    ...
    <p className="text-sm text-gray-700">₹3,373 + ₹731 taxes</p>
    <p className="font-semibold text-gray-900 mt-1">Total: ₹4,104</p>
  </a>
  ...
  >
    ...
    <p className="text-sm text-gray-700">₹3,650 + ₹864 taxes</p>
    <p className="font-semibold text-gray-900 mt-1">Total: ₹4,514</p>
  </a>
  ...
  >
    ...
    <p className="text-sm text-gray-700">
      ₹3,485 <span className="italic text-gray-500">(before taxes)</span>
    </p>
    <p className="font-semibold text-gray-900 mt-1">Est. Total: ₹3,485+</p>
  </a>
