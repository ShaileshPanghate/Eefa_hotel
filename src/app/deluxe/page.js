    ...
    <div className="bg-white text-gray-800">
      ...
      <section className="max-w-5xl mx-auto px-6 pb-10">
        ...
        <p className="text-gray-600 leading-relaxed text-[15px] font-light max-w-3xl mb-6">
          The attractively-equipped Deluxe rooms are beautifully decorated with double beds and twin beds and are equipped with all the comforts that are ideal for both business or leisure travellers.
        </p>
...
<section className="max-w-5xl mx-auto px-6 pb-16">
  ...
  >
    ...
    <p className="text-sm text-gray-700">₹2,998 + ₹731 taxes</p>
    <p className="font-semibold text-gray-900 mt-1">Total: ₹3,729</p>
  </a>
  ...
  >
    ...
    <p className="text-sm text-gray-700">₹3,423 + ₹864 taxes</p>
    <p className="font-semibold text-gray-900 mt-1">Total: ₹4,287</p>
  </a>
  ...
  >
    ...
    <p className="text-sm text-gray-700">
      ₹2,993 <span className="italic text-gray-500">(before taxes)</span>
    </p>
    <p className="font-semibold text-gray-900 mt-1">Est. Total: ₹2,993+</p>
  </a>
