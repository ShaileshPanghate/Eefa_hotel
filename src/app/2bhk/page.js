    ...
    <div className="bg-white text-gray-800">
      ...
      <section className="max-w-5xl mx-auto px-6 pb-10">
        ...
        <p className="text-gray-600 leading-relaxed text-[15px] font-light max-w-3xl mb-6">
          The perfectly-appointed Two Bedroom Apartment are spacious and vibrant and are ideal for family or long staying business traveller, equipped with all the modern facilities.
        </p>
