    ...
    <div className="bg-white text-gray-800">
      ...
      <section className="max-w-5xl mx-auto px-6 pb-10">
        ...
        <p className="text-gray-600 leading-relaxed text-[15px] font-light max-w-3xl mb-6">
          Designed as an artist’s studio, the room feature an king-size bed, and an appealing interior with splendid artwork that makes a lofts room. The studio room is ideal for a family of 4 who want to stay together in the same room.
        </p>
...
<section className="max-w-5xl mx-auto px-6 pb-16">
  ...
  >
    ...
    <p className="text-sm text-gray-700">₹3,678 + ₹893 taxes</p>
    <p className="font-semibold text-gray-900 mt-1">Total: ₹4,575</p>
  </a>
  ...
  >
    ...
    <p className="text-sm text-gray-700">₹3,723 + ₹940 taxes</p>
    <p className="font-semibold text-gray-900 mt-1">Total: ₹4,663</p>
  </a>
  ...
  >
    ...
    <p className="text-sm text-gray-700">
      ₹3,685 <span className="italic text-gray-500">(before taxes)</span>
    </p>
    <p className="font-semibold text-gray-900 mt-1">Est. Total: ₹3,685+</p>
  </a>
