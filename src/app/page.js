      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="bg-green-100 border border-green-300 rounded-lg p-6 mb-8 shadow flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-2xl text-green-900 font-bold mt-1">Starting at ₹3,100</p>
          ...
          <table className="min-w-full border-collapse border text-sm sm:text-base text-gray-800">
            <thead>
              <tr className="bg-gray-200 text-black">
                ...
                <th className="px-4 py-3 border text-left text-green-900">Direct Booking </th>
              </tr>
            </thead>
            <tbody>
              {/* Standard */}
              <tr className="bg-yellow-50">
                ...
                <td className="px-4 py-3 border font-semibold text-red-900">₹3,862</td>
                <td className="px-4 py-3 border font-semibold text-yellow-900">₹3,780</td>
                <td className="px-4 py-3 border font-semibold text-indigo-900">₹4,118</td>
                <td className="px-4 py-3 border font-semibold text-green-900">₹3,118</td>
              ...
              <tr className="bg-indigo-50">
                ...
                <td className="px-4 py-3 border text-green-900">₹3,418</td>
          ...
          <div className="flex justify-center gap-3 flex-nowrap mb-8 overflow-hidden">
            {destinations.map((place, index) => (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 text-sm md:text-base rounded whitespace-nowrap ${activeIndex === index
